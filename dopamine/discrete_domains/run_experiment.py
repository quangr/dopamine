...
from dopamine.jax.agents.implicit_quantile_star import implicit_quantile_agent_star as jax_implicit_quantile_star_agent
from dopamine.jax.agents.non_decreasing_quantile import non_decreasing_quantile as jax_non_decreasing_quantile_agent
...
def create_agent(sess, environment, agent_name=None, summary_writer=None,
  ...
  if agent_name.startswith('dqn'):
    ...
    return jax_implicit_quantile_agent.JaxImplicitQuantileAgent(
        num_actions=environment.action_space.n,
        summary_writer=summary_writer)
  elif agent_name == 'jax_non_decreasing_quantile':
    return jax_non_decreasing_quantile_agent.JaxNonDecreasingQuantileStarAgent(
        num_actions=environment.action_space.n,
        summary_writer=summary_writer)
  elif agent_name == 'jax_implicit_quantile_star':
    return jax_implicit_quantile_star_agent.JaxImplicitQuantileStarAgent(
        num_actions=environment.action_space.n,
        summary_writer=summary_writer)
  else:
